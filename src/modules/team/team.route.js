...
const { create, addPlayer, removePlayer, assignCaptain, getById, getAll } = require('./team.controller')
...
teamRouter.get('/:id', validateUserJWT, getById)
teamRouter.get('/', validateUserJWT, getAll)
